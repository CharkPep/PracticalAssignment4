...
namespace Lab5_2
{
    public class Magazine : Printable
    {
        ...
        private Magazine(Printable printable, int ID, DateTime RealiseDate, CoverType Cover) : base(printable)
        {
            this.ID = ID;
            this.RealiseDate = RealiseDate;
            this.Cover = Cover;
        }
        public Magazine(Purpose PrintPurpose, string Name, IEnumerable<string> Authors, int PageNumber, decimal Rate, decimal Price, int SoldNumber, int ID, DateTime RealiseDate, CoverType Cover) : base(PrintPurpose, Name, Authors, PageNumber, Rate, Price, SoldNumber)
        {
            this.ID = ID;
            this.RealiseDate = RealiseDate;
            this.Cover = Cover;
