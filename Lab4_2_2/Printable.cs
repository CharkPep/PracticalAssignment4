...
namespace Lab5_2
{
    ...
    {
        public IPrintable.Purpose PrintPurpose { get; }
        ...
        public Printable(IPrintable.Purpose PrintPurpose, string Name, IEnumerable<string> Authors, int PageNumber, decimal Rate, decimal Price, int SoldNumber)
        {
            if(PageNumber < 0)
            {
